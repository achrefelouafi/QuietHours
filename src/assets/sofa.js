...
(QH => {
  ...
  QH.assets.sofa = (x, y, o = {}) => {
    ...
    box(x, y, 0.7, 0.5, d, 0.7, M.navy, { colTop: M.navyLt });                    // far arm

    const back  = () => box(x, backY, 0.7, w, 0.6, 0.75, M.navy, { colTop: M.navyLt });
    const seats = () => {
    ...
    box(x + w - 0.5, y, 0.7, 0.5, d, 0.7, M.navy, { colTop: M.navyLt });          // near arm
