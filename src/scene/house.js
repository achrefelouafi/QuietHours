/* ═══════════════════════════════════════════════════════════════
   ...
   QH.scenes.house → { rooms, bounds, draw, lights, lamps, neons, strips, pcs, mixers, arcades, blinds, duvets, chairs, storms, tubs, shows, sites, records, busy, boundsOf }
   ═══════════════════════════════════════════════════════════════ */
(QH => {
  const { at } = QH.cam;
  ...
  /** The screens' geometry from the last draw, in the rooms where a click on one opens a web page. */
  const sites  = () => rooms.filter(r => r.scene.site).map(r => ({ id: r.id, name: r.name, geo: r.scene.site() }));
