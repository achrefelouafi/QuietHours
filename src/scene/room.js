/* ═══════════════════════════════════════════════════════════════
   ...
   QH.scenes.room(W, D, H) → { W, D, H, WT, floor(), walls() }
   ═══════════════════════════════════════════════════════════════ */
(QH => {
  const M = QH.M;
  const { box, stroke, rgb, grain } = QH.draw;

  QH.scenes.room = (W, D, H, WT = 0.4) => ({
    W, D, H, WT,

    floor() {
      box(0, 0, -0.35, W, D, 0.35, M.navyDk, { colTop: M.navyDk, top: 1, left: 0.85, right: 0.65, edgeCol: M.navy });
